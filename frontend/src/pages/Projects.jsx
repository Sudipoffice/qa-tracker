...
function ProjectCard({ project, onEdit, onDelete }) {
  ...
  return (
    <div
      className="bg-white rounded-xl border border-gray-200 overflow-hidden cursor-pointer transition-all duration-150 hover:border-gray-300 hover:shadow-sm hover:-translate-y-px animate-slide-up group"
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <select
            value={sort}
            onChange={handleSort}
            className="w-full sm:w-auto px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white text-gray-700 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
          >
            {sortOptions.map(opt => (
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white text-gray-900 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
            >
